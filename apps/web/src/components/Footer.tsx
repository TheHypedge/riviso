        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              India's #1 SEO Analytics Platform. Comprehensive website analysis and optimization tools for businesses of all sizes.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-primary-400 transition-colors hover-scale p-2 rounded-lg hover:bg-gray-800">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/features" className="text-gray-300 hover:text-primary-400 transition-colors text-sm hover-lift block py-1">
                  Features
                </Link>
              </li>
              <li>
                <Link href="/pricing" className="text-gray-300 hover:text-primary-400 transition-colors text-sm hover-lift block py-1">
                  Pricing
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-gray-300 hover:text-primary-400 transition-colors text-sm hover-lift block py-1">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/resources-checker" className="text-gray-300 hover:text-primary-400 transition-colors text-sm hover-lift block py-1">
                  Resources Checker
                </Link>
              </li>
              <li>
                <Link href="/domain-history-checker" className="text-gray-300 hover:text-primary-400 transition-colors text-sm hover-lift block py-1">
                  Domain History
                </Link>
              </li>
              <li>
                <Link href="/onpage-optimization" className="text-gray-300 hover:text-primary-400 transition-colors text-sm hover-lift block py-1">
                  On-Page SEO
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/terms-conditions" className="text-gray-300 hover:text-primary-400 transition-colors text-sm hover-lift block py-1">
                  Terms & Conditions
                </Link>
              </li>
              <li>
                <Link href="/refund-cancellation" className="text-gray-300 hover:text-primary-400 transition-colors text-sm hover-lift block py-1">
                  Refund & Cancellation
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm">
              © {new Date().getFullYear()} RIVISO. All rights reserved.
            </div>
            <div className="mt-4 md:mt-0 flex space-x-6">
              <Link href="/privacy-policy" className="text-gray-400 hover:text-primary-400 transition-colors text-sm hover-lift">
                Privacy
              </Link>
